 ...
 */
public class UserProfileEditActivity extends AppCompatActivity implements SaveCallback, GetCallback<User> {
    ...
    void setupProfileImage() {
        ivProfileImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ImageHelper.startImagePickerActivity(UserProfileEditActivity.this);
            }
        });
    }
        ...
        mUser.getAddress().fetchIfNeededInBackground(new GetCallback<Address>() {
            ...
            public void done(Address address, ParseException e) {
                if (e == null) {
                    ...
                    Toast.makeText(UserProfileEditActivity.this, "Failed to fetch user address", Toast.LENGTH_LONG).show();
                }
            }
        });
            ...
            query.getInBackground(petObjectId, new GetCallback<Pet>() {
                ...
                public void done(Pet pet, ParseException e) {
                    if (e == null) {
                        ...
                        Toast.makeText(UserProfileEditActivity.this, "Failed to fetch added pet", Toast.LENGTH_LONG).show();
                    }
                }
            });
                ...
                pet.fetchInBackground(new GetCallback<ParseObject>() {
                    ...
                    public void done(ParseObject object, ParseException e) {
                        if (e == null) {
                            ...
                            Toast.makeText(UserProfileEditActivity.this, "Failed to fetch pet changes", Toast.LENGTH_LONG).show();
                        }
